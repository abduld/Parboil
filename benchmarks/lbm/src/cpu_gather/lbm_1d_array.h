...
#define TRANS_SRC_C(g)  (GRID_ENTRY_SWEEP( g, 0, 0, 0, C  ))
#define TRANS_SRC_N(g)  (GRID_ENTRY_SWEEP( g, 0, -1, 0, N  ))
#define TRANS_SRC_S(g)  (GRID_ENTRY_SWEEP( g, 0, 1, 0, S  ))
#define TRANS_SRC_E(g)  (GRID_ENTRY_SWEEP( g, -1, 0, 0, E  ))
#define TRANS_SRC_W(g)  (GRID_ENTRY_SWEEP( g, 1, 0, 0,W  ))
#define TRANS_SRC_T(g)  (GRID_ENTRY_SWEEP( g, 0, 0, -1, T  ))
#define TRANS_SRC_B(g)  (GRID_ENTRY_SWEEP( g, 0, 0, 1, B  ))
#define TRANS_SRC_NE(g) (GRID_ENTRY_SWEEP( g, -1, -1, 0, NE ))
#define TRANS_SRC_NW(g) (GRID_ENTRY_SWEEP( g, 1, -1, 0, NW ))
#define TRANS_SRC_SE(g) (GRID_ENTRY_SWEEP( g, -1, 1, 0, SE ))
#define TRANS_SRC_SW(g) (GRID_ENTRY_SWEEP( g, 1, 1, 0, SW ))
#define TRANS_SRC_NT(g) (GRID_ENTRY_SWEEP( g, 0, -1, -1, NT ))
#define TRANS_SRC_NB(g) (GRID_ENTRY_SWEEP( g, 0, -1, 1, NB ))
#define TRANS_SRC_ST(g) (GRID_ENTRY_SWEEP( g, 0, 1, -1, ST ))
#define TRANS_SRC_SB(g) (GRID_ENTRY_SWEEP( g, 0, 1, 1, SB ))
#define TRANS_SRC_ET(g) (GRID_ENTRY_SWEEP( g, -1, 0, -1, ET ))
#define TRANS_SRC_EB(g) (GRID_ENTRY_SWEEP( g, -1, 0, 1, EB ))
#define TRANS_SRC_WT(g) (GRID_ENTRY_SWEEP( g, 1, 0, -1, WT ))
#define TRANS_SRC_WB(g) (GRID_ENTRY_SWEEP( g, 1, 0 ,1, WB ))

#define TRANS_DST_C(g)  (LOCAL ( g, C  ))
#define TRANS_DST_N(g)  (LOCAL ( g, N  ))
#define TRANS_DST_S(g)  (LOCAL ( g, S  ))
#define TRANS_DST_E(g)  (LOCAL ( g, E  ))
#define TRANS_DST_W(g)  (LOCAL ( g, W  ))
#define TRANS_DST_T(g)  (LOCAL ( g, T  ))
#define TRANS_DST_B(g)  (LOCAL ( g, B  ))
#define TRANS_DST_NE(g) (LOCAL( g, NE ))
#define TRANS_DST_NW(g) (LOCAL( g, NW ))
#define TRANS_DST_SE(g) (LOCAL( g, SE ))
#define TRANS_DST_SW(g) (LOCAL( g, SW ))
#define TRANS_DST_NT(g) (LOCAL( g, NT ))
#define TRANS_DST_NB(g) (LOCAL( g, NB ))
#define TRANS_DST_ST(g) (LOCAL( g, ST ))
#define TRANS_DST_SB(g) (LOCAL( g, SB ))
#define TRANS_DST_ET(g) (LOCAL( g, ET ))
#define TRANS_DST_EB(g) (LOCAL( g, EB ))
#define TRANS_DST_WT(g) (LOCAL( g, WT ))
#define TRANS_DST_WB(g) (LOCAL( g, WB ))

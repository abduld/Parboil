...
void checkSignature(char* s, cl_command_queue command_queue, cl_mem memobj) {
  size_t sz;
...
*/
    imgRef = clCreateBuffer(clContext,
  ...
  // checkSignature("d_sads", clCommandQueue, d_sads);

...
PLATFORM_CFLAGS = -g -O3 -xHOST
  
CXX = $(INTEL_COMPOSER_PATH)/bin/intel64/icpc
PLATFORM_CXXFLAGS = -g -O3 -xHOST

LINKER = $(INTEL_COMPOSER_PATH)/bin/intel64/icc
PLATFORM_LDFLAGS = -lm -lpthread -lrt -Wl,-rpath,'$$ORIGIN:${INTEL_COMPOSER_PATH}/compiler/lib/intel64:${INTEL_COMPOSER_PATH}/tbb/lib/intel64' -g

CCL = $(MXPA_PATH)/bin/mxpa.py
PLATFORM_CCLFLAGS = -c icc_cean --keep --debug --verbose

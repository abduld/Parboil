...
PLATFORM_CFLAGS = -D__MXPA__
  
CXX = $(INTEL_COMPOSER_PATH)/bin/intel64/icpc
PLATFORM_CXXFLAGS = -D__MXPA__

# Force pointing to the previous one...
MXPA_PATH=$(MOPENCL_PATH)

LINKER = $(INTEL_COMPOSER_PATH)/bin/intel64/icc
PLATFORM_LDFLAGS = -lm -lpthread -Wl,-rpath,'$$ORIGIN:${INTEL_COMPOSER_PATH}/compiler/lib/intel64:${INTEL_COMPOSER_PATH}/tbb/lib/intel64' -g -L$(MXPA_PATH)/lib -ltbb

CCL = $(MXPA_PATH)/bin/mxpa.py
PLATFORM_CCLFLAGS = -c mxpa_default --keep --verbose
...
LIBOPENCL=-lmxpa_runtime -ldl -ltbbmalloc -L$(OPENCL_LIB_PATH) -L${INTEL_COMPOSER_PATH}/tbb/lib/intel64
